...
$order_number=0;
   ...
   $sql="SELECT s.id,u.user_name,u.full_name FROM `shipment_order` as s left join user_profile as u on s.created_by=u.id where (cancelled is null or cancelled=0) and billoflading_id=".$this->requestUrl[2];
...
// get Detail
$sql="select Description_of_goods from bill_of_lading_detail where  billoflading_id=".$this->requestUrl[2];
