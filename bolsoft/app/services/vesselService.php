...
switch ($this->requestUrl[1]) {
    ...
    break;
    case 'excel':    
    $sql="SELECT v.vessel_name,v.vessel_code,v.lloyd_number,c.country_name,v.id from vessel as v left join country as c on v.country_id=c.id  order by vessel_name ";
    break;
    case 'DELETE':
