...
$this->Cell(150,10,'United Freight Forwarders Ltd',0,0,'C');
$this->Cell(1,5,'',0,1,'C');
...
if ($claims==null){    
 ...
 $sql="select o.id,o.order_date,o.cancel_date,x.user_name as cancel_by,u.user_name from ((shipment_order as o left join user_profile as u on o.created_by=u.id) left join user_profile as x on o.cancel_by=x.id)   where o.cancelled=1 and o.order_date between $request[0] and $request[1] order by o.id ";
