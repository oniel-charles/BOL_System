...
$y=$pdf->GetY();	
$pdf->SetFont('Arial','B',12);
$pdf->Cell(94,7,'Shipper Address',0,1);
$pdf->SetFont('Arial','',12);
//$pdf->Cell(94,5,$rec->shipper_name,0,1);
$pdf->MultiCell( 94, 5, $rec->shipper_name, 0,1);
$pdf->MultiCell( 94, 5, $rec->shipper_address, 0,1);

$pdf->SetY($y);
$pdf->SetX(104);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(94,7,'Consignee Address',0,1);
$pdf->SetFont('Arial','',12);
$pdf->SetX(104);
//$pdf->Cell(94,5,$rec->consignee_name,0,1);
$pdf->MultiCell( 94, 5, $rec->consignee_name, 0,1);
$pdf->SetX(104);
...
$y=$pdf->GetY();
$x=$pdf->GetX();
$pdf->Cell(50,7,'Freight : '.number_format($rec->value_of_goods,2).' USD ',0,1);
$pdf->SetX($x);
$pdf->Cell(17,7,'Weight : '.$total_weight.' KG',0,1);
$pdf->Cell(30,7,'Port of Loading : ',0,0);
$pdf->Cell(60,7,$rec->loading,0,0);
$pdf->SetX($x);
$pdf->Cell(17,7,'Measurement : '.$total_measure.' CBM',0,1);
$pdf->Ln();
